...
interface dataCollection {
	...
	'recipe-category': { [key: string]: PrototypeRecipeCategory }
...
interface PrototypeRecipe extends PrototypeBase {
    ingredients: IngredientPrototype[] | Array<[string, number]>
    ...
    category?: string
    crafting_machine_tint?: RecipeTints | Color[]
    emissions_multiplier?: number
    enabled?: boolean
...
interface PrototypeRecipeCategory extends PrototypeBase {
	name: string
	type: string
